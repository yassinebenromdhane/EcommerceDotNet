...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.BrandId).HasName("PK__brands__5E5A8E276E811F0F");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__categori__D54EE9B4863CE3A4");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB85D9D420E5");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__orders__46596229CE32593B");
        ...
        {
            entity.HasKey(e => new { e.OrderId, e.ItemId }).HasName("PK__order_it__837942D465EC3843");
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("PK__products__47027DF5A5167D5D");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staffs__1963DD9C0D6049BD");

            entity.ToTable("staffs");

            entity.HasIndex(e => e.Email, "UQ__staffs__AB6E6164FA25FFD5").IsUnique();
        ...
        {
            entity.HasKey(e => new { e.StoreId, e.ProductId }).HasName("PK__stocks__E68284D3E039EDFD");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__stores__A2F2A30C72A59A2B");
